...
-- Pasting over a selection will not overrwrite the paste register.
...
vim.keymap.set('n', '<leader>q', '<cmd>:Trouble diagnostics<CR>', { desc = 'Open diagnostic [Q]uickfix list' })
